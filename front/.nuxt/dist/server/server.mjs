...
// --------------------
const $id_8530f7fa = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/node_modules/nuxt/dist/app/index.mjs");
const __vite_ssr_import_1__ = await __vite_ssr_import__("/node_modules/vue/dist/vue.cjs.js");
...
const _sfc_main = /* @__PURE__ */ __vite_ssr_import_1__.defineComponent({
  async setup(__props, { expose }) {
    ...
    const { data: article } = ([__temp, __restore] = __vite_ssr_import_1__.withAsyncContext(() => __vite_ssr_import_0__.useFetch("http://localhost:1337/api/articles/" + route.params.id + "?populate=image")), __temp = await __temp, __restore(), __temp);
    const __returned__ = { config, route, article };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${__vite_ssr_import_2__.ssrRenderAttrs(_attrs)}><h1>${__vite_ssr_import_2__.ssrInterpolate($setup.article.data.attributes.title)}</h1> Created ${__vite_ssr_import_2__.ssrInterpolate($setup.article.data.attributes.createdAt)}, Edited ${__vite_ssr_import_2__.ssrInterpolate($setup.article.data.attributes.updatedAt)} <img${__vite_ssr_import_2__.ssrRenderAttr("src", `${$setup.config.API_URL}${$setup.article.data.attributes.image.data.attributes.url}`)}><p>${__vite_ssr_import_2__.ssrInterpolate($setup.article.data.attributes.content)}</p></div>`);
}
...
const _sfc_main = /* @__PURE__ */ __vite_ssr_import_2__.defineComponent({
  async setup(__props, { expose }) {
    expose();
    let __temp, __restore;
    const config = __vite_ssr_import_1__.useRuntimeConfig().public;
    const { data: articles } = ([__temp, __restore] = __vite_ssr_import_2__.withAsyncContext(() => __vite_ssr_import_1__.useFetch("http://localhost:1337/api/articles?sort=updatedAt:desc&populate=image")), __temp = await __temp, __restore(), __temp);
    const __returned__ = { config, articles };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_4__.ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-bold text-orange-500 text-orange"> Bloggames </h1><div class="grid grid-cols-3 gap-0.5 flex justify-items-center"><!--[-->`);
  __vite_ssr_import_4__.ssrRenderList($setup.articles.data, (article) => {
    _push(`<div>`);
    _push(__vite_ssr_import_4__.ssrRenderComponent(_component_NuxtLink, {
      ...
      default: __vite_ssr_import_3__.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="underline-offset-1 underline decoration-sky-500"${_scopeId}>${__vite_ssr_import_4__.ssrInterpolate(article.attributes.title)}</div>`);
        } else {
          return [
            __vite_ssr_import_3__.createVNode("div", { class: "underline-offset-1 underline decoration-sky-500" }, __vite_ssr_import_3__.toDisplayString(article.attributes.title), 1)
          ];
        }
      }),
      _: 2
    }, _parent));
    _push(`<img${__vite_ssr_import_4__.ssrRenderAttr("src", `${$setup.config.API_URL}${article.attributes.image.data.attributes.formats.small.url}`)}></div>`);
  });
  _push(`<!--]--></div></div>`);
}
...
// - /@id/plugin-vue:export-helper ($id_bbb863c1)
// --------------------
const $id_c6f02538 = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/node_modules/nuxt/dist/app/index.mjs");
const __vite_ssr_import_1__ = await __vite_ssr_import__("/node_modules/vue/dist/vue.cjs.js");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_3__.ssrRenderAttrs(_attrs)}><!--	 NAVBAR--><header class="sticky z-50 w-full py-2 bg-blue-300"><div class="grid grid-cols-4 gap-4 justify-items-center"><div>BlogGame brand</div><div>`);
  _push(__vite_ssr_import_3__.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: __vite_ssr_import_2__.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="rounded-lg px-2 bg-indigo-500 hover:bg-cyan-600"${_scopeId}> HOME </button>`);
      } else {
        return [
          __vite_ssr_import_2__.createVNode("button", { class: "rounded-lg px-2 bg-indigo-500 hover:bg-cyan-600" }, " HOME ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</div><div> article searchbar ? </div></div></header>`);
  _push(__vite_ssr_import_3__.ssrRenderComponent(_component_NuxtPage, null, null, _parent));
  _push(`<!--	 BOTTOMBAR--><div class="bottom-0 w-full bg-blue-200">BlogGame bottombar</div></div>`);
}
const __vite_ssr_import_4__ = await __vite_ssr_import__("/node_modules/vue/dist/vue.cjs.js");
